;メッセージレイヤの定義
		...
		[position width=800 height=100 top=600 left=220 ]


		
			[position page=fore margint=1 marginl=1 marginr=1 marginb=1 vertical=false opacity="80" radius="15" color="0x000000" ]
		...
		[position layer="message1" width=800 height=100 top=600 left=220 ]
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="80" radius="15" color="0x000000" ]
